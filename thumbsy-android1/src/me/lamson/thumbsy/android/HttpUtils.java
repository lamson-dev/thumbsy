...
public class HttpUtils {
	...
	/**
	 * Maximum total size of HTTP response that will be read. Larger responses
	 ...
	 * 
	 * @param response
	 *            the HttpResponse to be read.
	 * @return the content of the HttpResponse as a ByteArrayOutputStream.
	 * @throws IOException
	 *             if the content size exceeds {@link #MAX_READ_SIZE} bytes.
	 */
	public static ByteArrayOutputStream getContent(HttpResponse response)
			throws IOException {
	 ...
	 *             if the content size exceeds {@link #MAX_READ_SIZE} bytes.
	 */
	public static ByteArrayOutputStream getContent(InputStream inputStream)
			throws IOException {
