...
public class DatastoreUtils {
	...
	private static final Logger logger = Logger.getLogger(DatastoreUtils.class
			.getCanonicalName());
	...
	public static Iterable<Entity> listEntities(String kind, String searchBy,
		...
		if (messageId != null && !"".equals(messageId)) {
			q.addFilter(searchBy, FilterOperator.EQUAL, messageId);
		}
	...
	public static String writeJSON(Iterable<Entity> entities, String childKind,
		...
		for (Entity result : entities) {
			...
			Iterable<Entity> child = listEntities(childKind, fkName, result
					.getKey().getId());
			for (Entity en : child) {
